...
begin
 if (Self.HVs.Count > 0) then
  begin
   ...
   Self.gui.P_status.Hint    := 'Odeslán požadavek na odhlášení lokomotiv, čekám na odpověď...';
  end;
...
begin
 ...
 Self.gui.P_status.Color   := clAqua;
 Self.gui.P_status.Caption := '...';
 Self.gui.P_status.Hint    := 'Odeslán požadavek na totální řízení, čekám na odpověď...';
